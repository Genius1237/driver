...
if __name__ == "__main__":  
    ...
    parser.add_argument("--titlebar-adjustment",type=int,default=40,help='number of pixels taken up by the titlebar, which is used to specify the region of the screen to capture')
